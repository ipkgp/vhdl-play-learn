...
  ];
  ...
  // 4. O array codeExamples foi REMOVIDO

  return (
    <section id="learning-section" className="py-20 px-6">
      <div className="max-w-7xl mx-auto">
        {/* Basic Concepts Section (FICA) */}
...
        {/* Advanced Concepts Section (FICA) */}
        <div className="text-center mb-16">
...
        {/* 5. A secção "Code Examples" foi REMOVIDA daqui */}
